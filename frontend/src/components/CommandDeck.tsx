      ...
      <div className="bg-surface/80 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-2xl shadow-black/50 relative">
        <div className="flex justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
              <div className="relative group/mesh flex items-center gap-1">
                  <button
                  ...
                  <button
                      ...
                      className="p-1.5 rounded-lg transition-colors hover:bg-white/20 text-white/50 hover:text-white"
                  >
